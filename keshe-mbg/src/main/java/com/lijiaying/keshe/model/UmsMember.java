...
public class UmsMember implements Serializable {
    ...
    @ApiModelProperty(value = "账号删除状态:0->未删除；1->删除")
    private Integer isDelete;

    @ApiModelProperty(value = "账户注销原因")
    private String cancellationReason;

    @ApiModelProperty(value = "1 - 个人 2 - 企业招聘者")
    ...
    public String toString() {
        ...
        sb.append(", workCard=").append(workCard);
